...
The University has asked all faculty to inform students of these procedures, prepared by the GW Office of Public Safety and Emergency Management in collaboration with the Office of the Executive
...
there is a large group of people inside a particular building, several rooms may be necessary.
...
call in the list.
- Await further instructions. If possible, visit GW Campus Advisories for incident updates or call the
...
Once you have evacuated the building, proceed to our primary rendezvous location: the court yard
...
### GW Alert
GW Alert provides popup notification to desktop and laptop computers during an emergency. In the
...
operating status can be found on GW Campus Advisories or by calling the GW Information Line at
202-994-5050.
...
You can download a PDF version of this syllabus [here](iaff_6501.pdf).

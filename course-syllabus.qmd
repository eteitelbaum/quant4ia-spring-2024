...
Location: Gelman Library, Rm 609

| Instructor: Prof. Emmanuel Teitelbaum
| Email: [ejt\@gwu.edu](mailto:ejt@gwu.edu)

The best way to contact me is via the course Discord server.

Office Hours: [Mondays 3-5 p.m.](https://calendly.com/emmanuel-teitelbaum) and by appointment.
...
We will communicate primarily through [GW's Blackboard System](https://blackboard.gwu.edu) and the Discord server. Announcements and emails sent through Blackboard automatically go to your GW email address (i.e., userid\@gwu.edu). Please check your GW email account on a daily basis or forward your GW email to another address that you check daily.

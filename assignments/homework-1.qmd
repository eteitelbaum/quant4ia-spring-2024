...
Finally, go ahead and download the Homework 1 assignment from the IAFF 6501 [classwork folder](https://www.dropbox.com/scl/fo/mi8lvj38jucku9qhavsll/h?rlkey=vui8jhnpny8zvvu69tu39pukz&dl=0). 
...
*Write a brief conclusion to your analysis. What did you find? Did you find support for Lipset's theory? What are the limitations of your analysis?*
...
After you complete the assignment, please render it and uplaod your project folder [using this link](https://www.dropbox.com/request/S74tp3nfDiUyDtPKgHPy). Take a screen shot of the confirmation message ("Finished Uploading") and store it on your computer. 

Then, make your way over to the Blackboard site and go to the Homework 1 assignment submission page. Click "Create Sumbission" and there write a statement saying that you have submitted the assignment and that all of the work is your own. If you have uploaded your document to Quarto Pub, then you can include the link to that as well. 

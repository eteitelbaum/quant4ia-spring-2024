...
As an alternative assignment to the Shiny App, you can produce a short report or presentation with some data visualizations embedded in it. The purpose of this assignment is to give you an opportunity to practice incorporating basic data visualizations into your workflow. You will render your Quarto document as either an HTML or revealjs slides and upload the finished product to [Quarto Pub](https://quartopub.com/). Then you will share the link with the class on Discord. 

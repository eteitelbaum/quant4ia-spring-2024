...
execute:
  eval: false # change to true if incorporated in course
  echo: true  # and add back the data (which has been removed)
  message: false
  warning: false
---
...
After you have downloaded the data and saved it in your modules folder, go ahead and, read it in and have a look at its contents with `glimpse()`. 
